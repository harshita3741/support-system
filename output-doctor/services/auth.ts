...
export class AuthService {
  ...
  private mockDoctors = [
    ...
    { username: 'dr.johnson', password: '1234', name: 'Dr. Johnson', dept: 'GENERAL',  id: '4', role: 'DOCTOR' },
    { username: 'nurse.cardio', password: '1234', name: 'Nurse Priya', dept: 'CARDIO', id: '5', role: 'NURSE' },
    { username: 'nurse.neuro',  password: '1234', name: 'Nurse Rahul', dept: 'NEURO',  id: '6', role: 'NURSE' },
    { username: 'nurse.ortho',  password: '1234', name: 'Nurse Sneha', dept: 'ORTHO',  id: '7', role: 'NURSE' }
  ];
