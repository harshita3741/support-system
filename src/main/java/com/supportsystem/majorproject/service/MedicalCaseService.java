...
public class MedicalCaseService {
    ...
    public void createCase(MedicalCase medicalCase) {
        ...
        System.out.println("Medical case created and queued: " + medicalCase.getCaseId());
    }
    ...
    public String acceptCase(Long caseId, String doctorId) {
        ...
        if (mc != null) {
            ...
            if (doctorId != null && !doctorId.isEmpty()) {
                try { mc.setAssignedDoctorId(Long.parseLong(doctorId)); } catch (NumberFormatException ignored) {}
            }
            repository.save(mc);
            return "Accepted";
        }
